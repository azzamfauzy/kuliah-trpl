...
<!-- KODE TOMBOL CETAK BARU -->
<p style="text-align: center; margin-bottom: 20px;">
    <a href="cetak-materi.php" style="background-color: #2ecc71; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">🖨️ Cetak Rangkuman Materi (PDF)</a>
</p>
